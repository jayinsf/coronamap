...
export class CircleMarker implements ITemporal {
  ...
  public update(geoJson : any) {
    ...
    //create circles
    var features : object[];
    //extracts a portion of states from end of geojson
  ...
  public createTooltip(marker : any, contentText : string, options? : {}) : any {
    ...
    //attaches tooltip to circle marker
        ...
        if (numOfDeathsAtCurrentTime && numOfDeathsAtCurrentTime > 0) {
          try {
            ...
            if (!stateName) {
              ...
              //adds a comma between country name and state name if they exist
              stateName += ', ';
            }
            //shows number of confirmed cases
